...
class Register extends React.Component {
    ...
    onSubmitRegister = () => {
        ...
        fetch('https://pacific-beyond-35810.herokuapp.com/register', {
            method: 'post',
                    ...
                    <div className="measure">
                        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                            ...
                            <div className="mt3">
                                ...
                                <input onChange={(event) => this.setState({ name: event.target.value })} className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100 " type="text" name="name" id="name" />
                            </div>
                            <div className="mt3">
